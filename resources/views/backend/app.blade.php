...
<html lang="en">
	...
	<head>
		<base href="">
		<title>Home</title>
		<link rel="shortcut icon" href="{{asset('frontend/img/logo-png.png')}}" />
												...
												<div class="menu-item px-3">
													<div class="menu-content d-flex align-items-center px-3">
														...
														<div class="d-flex flex-column">
															<div class="fw-bolder d-flex align-items-center fs-5">Kafsh
															<span class="badge badge-light-success fw-bolder fs-8 px-2 py-1 ms-2">Pro</span></div>
															<a href="#" class="fw-bold text-muted text-hover-primary fs-7">kafshwearings@gmail.com</a>
														</div>
														<!--end::Username-->
													</div>
												</div>
