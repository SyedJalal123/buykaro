...
@section('content')
    ...
    <section class="col-12 container px-3">
        <div class="text-2 poppins-all">
            ...
            <span>
                This website is operated by Kafsh. Throughout the site, the terms “we”, “us” and “our” refer to &nbsp;Kafsh.&nbsp;Kafsh&nbsp;offers this website, including all information, tools and Services available from this site to you, the user, conditioned upon your acceptance of all terms, conditions, policies and notices stated here.
            </span><br><br>
            <span>
            ...
            <strong>3 - ACCURACY, COMPLETENESS AND TIMELINESS OF INFORMATION</strong>
            <span></span><br>
            <span>
