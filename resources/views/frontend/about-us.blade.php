        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 mb-3 mb-lg-0">
                    ...
                    <p>Welcome to Buy Karo, where your online shopping experience is elevated to new heights! Established with a passion for delivering quality products and exceptional service, Buy Karo is your go-to eCommerce destination.</p>
                </div><!-- End .col-lg-6 -->
                
                <div class="col-lg-6">
                    <h2 class="title">Our Mission</h2><!-- End .title -->
                    <p>At Buy Karo, we curate a diverse and trendsetting collection of products, ranging from fashion and electronics to home essentials, ensuring that our customers find everything they need in one convenient place. <br>
                        Our user-friendly platform is designed to provide a seamless and enjoyable shopping journey, allowing you to explore, discover, and purchase with confidence.</p>
                </div><!-- End .col-lg-6 -->
            </div><!-- End .row -->
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-5 mb-3 mb-lg-0">
                        ...
                        <p class="lead text-primary mb-3">Buy Karo is your ultimate online shopping destination in Pakistan, offering a diverse range of products.</p><!-- End .lead text-primary -->
                        <p class="mb-2">Join the Buy Karo community and indulge in a world of online shopping that prioritizes your needs and desires. Your satisfaction is our top priority, and we look forward to being your trusted partner in finding the best deals and the latest trends. Happy shopping at Buy Karo! </p>

                        <a href="{{url('collections/all')}}" class="btn btn-sm btn-minwidth btn-outline-primary-2">
